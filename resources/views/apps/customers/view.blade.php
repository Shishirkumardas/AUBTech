										...
										<div class="menu-sub menu-sub-accordion">
											...
											<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
												...
												<div class="menu-sub menu-sub-accordion">
													...
													<div class="menu-item">
														<!--begin:Menu link-->
														<a class="menu-link active" href="apps/customers/view.html">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
															<span class="menu-title">Customer Details</span>
								...
								<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex align-items-stretch">
									...
									<div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
										...
										<div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
											<!--begin::Title-->
											<h1 class="page-heading d-flex flex-column justify-content-center text-gray-900 fw-bold fs-3 m-0">Customer Details</h1>
											<!--end::Title-->
											<!--begin::Breadcrumb-->
														...
														<div class="card-body pt-0 pb-5">
															...
															<table class="table align-middle table-row-dashed gy-5" id="kt_table_customers_payment">
																...
																<tbody class="fs-6 fw-semibold text-gray-600">
																	<tr>
																		<td>
																			<a href="#" class="text-gray-600 text-hover-primary mb-1">9552-1849</a>
																		</td>
																		<td>
																	...
																	<tr>
																		<td>
																			<a href="#" class="text-gray-600 text-hover-primary mb-1">4745-9135</a>
																		</td>
																		<td>
																			<span class="badge badge-light-success">Successful</span>
																		</td>
																	...
																	<tr>
																		<td>
																			<a href="#" class="text-gray-600 text-hover-primary mb-1">2595-9256</a>
																		</td>
																		<td>
																			<span class="badge badge-light-success">Successful</span>
																		</td>
																	...
																	<tr>
																		<td>
																			<a href="#" class="text-gray-600 text-hover-primary mb-1">1043-8693</a>
																		</td>
																		<td>
																	...
																	<tr>
																		<td>
																			<a href="#" class="text-gray-600 text-hover-primary mb-1">1716-5131</a>
																		</td>
																		<td>
																			<span class="badge badge-light-success">Successful</span>
																		</td>
																	...
																	<tr>
																		<td>
																			<a href="#" class="text-gray-600 text-hover-primary mb-1">4380-7315</a>
																		</td>
																		<td>
																			<span class="badge badge-light-success">Successful</span>
																		</td>
																	...
																	<tr>
																		<td>
																			<a href="#" class="text-gray-600 text-hover-primary mb-1">5937-4559</a>
																		</td>
																		<td>
																			<span class="badge badge-light-success">Successful</span>
																		</td>
																	...
																	<tr>
																		<td>
																			<a href="#" class="text-gray-600 text-hover-primary mb-1">8532-1051</a>
																		</td>
																		<td>
																	...
																	<tr>
																		<td>
																			<a href="#" class="text-gray-600 text-hover-primary mb-1">9757-9736</a>
																		</td>
																		<td>
																			<span class="badge badge-light-warning">Pending</span>
																		</td>
																		...
																		<div class="flex-equal me-5">
																			<table class="table table-flush fw-semibold gy-1">
																				...
																				<tr>
																					...
																					<td class="text-gray-800">**** 7921</td>
																				</tr>
																				<tr>
																	...
																	<div class="d-flex flex-wrap py-5">
																		...
																		<div class="flex-equal me-5">
																			<table class="table table-flush fw-semibold gy-1">
																				...
																				<tr>
																					<td class="text-muted min-w-125px w-125px">Number</td>
																					<td class="text-gray-800">**** 6966</td>
																				</tr>
																				<tr>
																					<td class="text-muted min-w-125px w-125px">Expires</td>
																	...
																	<div class="d-flex flex-wrap py-5">
																		...
																		<div class="flex-equal me-5">
																			<table class="table table-flush fw-semibold gy-1">
																				...
																				<tr>
																					<td class="text-muted min-w-125px w-125px">Number</td>
																					<td class="text-gray-800">**** 1689</td>
																				</tr>
																				<tr>
																					<td class="text-muted min-w-125px w-125px">Expires</td>
																...
																<table class="table align-middle table-row-dashed fw-semibold text-gray-600 fs-6 gy-5" id="kt_table_customers_logs">
																	<tbody>
																		<tr>
																			...
																			<td>POST /v1/invoice/in_8739_6371/invalid</td>
																			<td class="pe-0 text-end min-w-200px">24 Jun 2023, 2:40 pm</td>
																		</tr>
																		<tr>
																			<td class="min-w-70px">
																				<div class="badge badge-light-danger">500 ERR</div>
																			</td>
																			<td>POST /v1/invoice/in_5046_8237/invalid</td>
																		...
																		<tr>
																			...
																			<td>POST /v1/invoices/in_8653_4493/payment</td>
																		...
																		<tr>
																			...
																			<td>POST /v1/invoices/in_5418_6651/payment</td>
																		...
																		<tr>
																			...
																			<td>POST /v1/customer/c_654c847e68977/not_found</td>
																			<td class="pe-0 text-end min-w-200px">15 Apr 2023, 11:05 am</td>
																		</tr>
																		<tr>
																			<td class="min-w-70px">
																				<div class="badge badge-light-danger">500 ERR</div>
																		...
																		<tr>
																			...
																			<td>POST /v1/invoices/in_1448_3950/payment</td>
																		...
																		<tr>
																			...
																			<td>POST /v1/invoice/in_4296_5886/invalid</td>
																		...
																		<tr>
																			...
																			<td>POST /v1/invoices/in_4210_1191/payment</td>
															...
															<table class="table align-middle table-row-dashed fs-6 text-gray-600 fw-semibold gy-5" id="kt_table_customers_events">
																<tbody>
																	<tr>
																		...
																		<td class="pe-0 text-gray-600 text-end min-w-200px">24 Jun 2023, 11:30 am</td>
																	</tr>
																	<tr>
																		<td class="min-w-400px">Invoice 
																	...
																	<tr>
																		...
																		<td class="pe-0 text-gray-600 text-end min-w-200px">21 Feb 2023, 10:30 am</td>
																	</tr>
																	<tr>
																		<td class="min-w-400px">Invoice 
																	...
																	<tr>
																		...
																		<span class="badge badge-light-succees me-1">In Transit</span>to 
																		<span class="badge badge-light-success">Approved</span></td>
																		<td class="pe-0 text-gray-600 text-end min-w-200px">05 May 2023, 2:40 pm</td>
																	</tr>
																	<tr>
																		<td class="min-w-400px">
																	...
																	<tr>
																		...
																		<a href="#" class="text-gray-600 text-hover-primary me-1">Brian Cox</a>has made payment to 
																		<a href="#" class="fw-bold text-gray-900 text-hover-primary">#OLP-45690</a></td>
																		<td class="pe-0 text-gray-600 text-end min-w-200px">20 Jun 2023, 9:23 pm</td>
																	</tr>
																	<tr>
																		<td class="min-w-400px">Invoice 
																		...
																		<td class="pe-0 text-gray-600 text-end min-w-200px">15 Apr 2023, 10:30 am</td>
																	</tr>
																	<tr>
																		<td class="min-w-400px">Invoice 
																		<a href="#" class="fw-bold text-gray-900 text-hover-primary me-1">#LOP-45640</a>has been 
																		<span class="badge badge-light-danger">Declined</span></td>
																		<td class="pe-0 text-gray-600 text-end min-w-200px">22 Sep 2023, 6:43 am</td>
																	</tr>
																</tbody>
															</table>
															<!--end::Table-->
